...
const Form = ({ token }) => {
  ...
  const fetchPasswords = async () => {
    const response = await fetch(`${process.env.REACT_BASE_API_URL}/api/password/list`, {
      method: 'GET',
      headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_BASE_API_URL}/api/password/delete/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const handle_data = async (e) => {
    ...
    if (editId) {
      ...
      try {
        const response = await fetch(`${process.env.REACT_BASE_API_URL}/api/password/edit/${editId}`, {
          method: 'PUT',
          headers: {
      ...
      // Add new password
      try {
        const response = await fetch(`${process.env.REACT_BASE_API_URL}/api/password/add`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
